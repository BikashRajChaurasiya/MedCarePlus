...
public class PatientRegisterServlet extends HttpServlet {
	...
	private String validate(Patient patient) {
		if (!ValidationUtil.hasText(patient.getFullName()))
		...
		if (!isNumeric(patient.getContactPhone()))
			return "Phone number must contain digits only.";
		if (!isNumeric(patient.getEmergencyContact()))
		...
		if (!ValidationUtil.hasText(patient.getAddress()))
			return "Address is required.";
		if (!ValidationUtil.hasText(patient.getBloodGroup()))
